...
public class SymbolTable {
     ...
     */
    Map<String, SymbolTableEntry> table=new HashMap<String, SymbolTableEntry>();
    ...
    public SymbolTableEntry add(String text) {
        ...
        if (!has(text)){
            table.put(text,symbolTableEntry);
        }else{
            throw new RuntimeException();
        }
        return symbolTableEntry;
    }
    public void set(String text,SourceCodeType type){
        SymbolTableEntry symbolTableEntry=new SymbolTableEntry(text);
        symbolTableEntry.setType(type);
        table.put(text,symbolTableEntry);
    }
